...
homerange %>% 
  ggplot(aes(x=taxon))+
  geom_bar()+
  coord_flip()+labs(title = "Obesevation by Taxon",x="Taxonomic Group",Y=NULL)# take away y axis label
```
...
homerange %>% 
  ...
  geom_bar()+
  coord_flip()+labs(title = "Obesevation by Taxon",x="Taxonomic Group",Y=NULL)
```
...
homerange %>% 
  ...
  theme(axis.text.x=element_text(angle = 60,hjust = 0.85))+
          labs(title = "Obesevation by Taxon",x="Taxonomic Group",Y=NULL)
```
