...
```{r, eval=F, echo=T}
ui <- fluidPage(
  titlePanel("Distribution of Gastation Length by Order"),
  selectInput("y",
              "Select the Variable",
              choices=c("bodymass",
                        "longevity",
...
ui <- dashboardPage(
  dashboardHeader(title="Distribution of Gastation Length by Order"),
...
ui <- dashboardPage(
  dashboardHeader(title="Distribution of wloves in different Populaion"),
  dashboardSidebar(
    selectInput("x",
                "Select Sex",
                choices=sort(unique(wolves$sex)),
                selected="AK.PEN"),
    selectInput("y",
                "Select Pop",
